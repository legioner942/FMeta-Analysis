...
namespace FMeta_Analysis {
    ...
    public sealed partial class FormState {
        ...
        public FormState() {
            ...
            //
            //if (Default.SaverFolder.Equals("")) Default.SaverFolder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"\FMeta";
        }
